...
public interface SearchRepository extends JpaRepository<Search, Long> {
    ...
    @Query(value = "SELECT "
            ...
            + " WHERE ( length(:sportName) = 0 OR s.sport_name = :sportName) "
    ...
    List<CustomSearch> findTeamSQL(String sportName, String prefectures, String activityFrequency, String dayOfTheWeek,
            String freeWord);
